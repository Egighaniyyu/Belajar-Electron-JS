...
function createWindow() {
  ...
  const child = new BrowserWindow({
    parent: win,
    //* modal akan memblokir parent window
    modal: true,
    width: 400,
    height: 200,
    autoHideMenuBar: true,
  ...
  //* loadfile digunakan untuk ngeload berdasarkan file local
  // child.loadFile("modal.html");

  //* loadurl digunakan untuk ngeload berdasarkan url web
  child.loadURL("https://www.electronjs.org/");
  child.show();
}
